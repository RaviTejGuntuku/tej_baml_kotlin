...
typeMap.register("TYPES", "LineItem", baml_client.types.LineItem::class, baml_client.types.LineItem)
    typeMap.register("STREAM_TYPES", "LineItem", baml_client.stream_types.LineItem::class, baml_client.stream_types.LineItem)
